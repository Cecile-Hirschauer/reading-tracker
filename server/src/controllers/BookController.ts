...
import { CreateBookRequest, UpdateBookRequest, UpdateProgressRequest } from '../models/types';
...
export class BookController {
   ...
   */
  static async getUserBooks(req: Request, res: Response): Promise<void> {
    try {
      const userId = (req as any).user?.userId;
  ...
  static async updateBook(req: Request, res: Response): Promise<void> {
    try {
      ...
      const book = await BookService.updateBook(bookId, userId, updateData);
  ...
  static async updateProgress(req: Request, res: Response): Promise<void> {
    try {
      ...
      const book = await BookService.updateProgress(bookId, userId, progressData);
  ...
  static async markAsCompleted(req: Request, res: Response): Promise<void> {
    try {
      ...
      const book = await BookService.markAsCompleted(bookId, userId);
   ...
   */
  static async getReadingStats(req: Request, res: Response): Promise<void> {
    try {
      const userId = (req as any).user?.userId;
  ...
  static async getBooksByCategory(req: Request, res: Response): Promise<void> {
    try {
      ...
      const booksByCategory = await BookService.getBooksByCategory(userId);
   ...
   */
  static async getCurrentlyReading(req: Request, res: Response): Promise<void> {
    try {
      const userId = (req as any).user?.userId;
   ...
   */
  static async getCompletedBooks(req: Request, res: Response): Promise<void> {
    try {
      const userId = (req as any).user?.userId;
